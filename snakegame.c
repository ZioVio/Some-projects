...
// -e - eat mode - you can eat a part of the snake
// without -e - you lose if smashing into the snake
// a secret super apple added))

// in future it is planned to separate this game into several files
struct pos {
    int x;
    int y;
};
